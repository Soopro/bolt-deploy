...
preset_element.innerHTML=preset.rendered||'';restoreSelection(savedRange);element=findTopElement(selectedNode);if(element&&element.nextSibling){$editor.insertBefore(preset_element,element.nextSibling);}else{$editor.appendChild(preset_element);}
