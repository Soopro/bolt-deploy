...
return new_list;};angular.capitalize=function(str){var e;try{return str.charAt(0).toUpperCase()+str.slice(1);}catch(error1){e=error1;return'';}}; angular.setdefault=function(dict,key,_default){if(dict[key]===void 0){dict[key]=_default;}
