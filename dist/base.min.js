...
selObj.extend(element,0);return historyManager.record();};clearFormat=function(e){var content,el,element,fmt_el,fmt_elements,i,j,l,len1,len2,sel_elements;if(!inEditor(selectedNode,true)){return;}
...
if(fmt_elements.length===1){clearTextWrapper(STYLE_TAGS);}else{for(l=0,len2=fmt_elements.length;l<len2;l++){element=fmt_elements[l];if(!element.innerHTML||!inEditor(element)){continue;}
