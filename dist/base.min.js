...
if(width||height){_w=_pre_media_size(width);_h=_pre_media_size(height);style_str='style="width:'+_w+';height:'+_h+';"';img.setAttribute('style','width:'+_w+';height:'+_h+';');}else{style_str='';}
