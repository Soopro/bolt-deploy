...
return new_list;};angular.capitalize=function(str){return str.charAt(0).toUpperCase()+str.slice(1);};angular.setdefault=function(dict,key,_default){if(dict[key]===void 0){dict[key]=_default;}
