...
return params;};console.log(angular.addURLParams('http://sss.com',{k:[1,2,3]},false));angular.getPureURL=function(url){try{return url.split(/[?#]/)[0];}catch(error1){return'';}}; angular.dataURLToBlob=function(dataURL){var BASE64_MARKER,contentType,i,parts,raw,rawLength,uInt8Array;BASE64_MARKER=';base64,';if(dataURL.indexOf(BASE64_MARKER)===-1){parts=dataURL.split(',');contentType=parts[0].split(':')[1];raw=parts[1];return new Blob([raw],{type:contentType});}
